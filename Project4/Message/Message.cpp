...
void Message::xmlRequest(const std::string& xmlTestReq)
{
   attributes_["xmlTestRequest"] = xmlTestReq;
}
//----< get xmlTestRequest attribute >-------------------------------------------

std::string Message::xmlTestRequest()
{
   if (containsKey("xmlTestRequest"))
   {
      return attributes_["xmlTestRequest"];
   }
   return "";
}
//----< set xmlTestRequest attribute >-------------------------------------------

void Message::xmlTestRequest(const std::string& xmlTestReq)
{
   attributes_["xmlRequest"] = xmlTestReq;
}
...
//----< set testResult attribute >-------------------------------------------

void Message::testResult(const std::string& testRslt)
{
   attributes_["testResult"] = testRslt;
}
//----< get testResult attribute >-------------------------------------------
