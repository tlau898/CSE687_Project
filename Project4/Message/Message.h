...
namespace MsgPassingCommunication
{
  ...
  public:
    ...
    std::string xmlRequest(); //XML Body TODEL
    void xmlRequest(const std::string& xmlReq);
    std::string xmlTestRequest(); //XML Body
    void xmlTestRequest(const std::string& xmlTestReq);
    std::string timeStamp(); //Time-Date
    void timeStamp(const std::string& timeStmp);
    std::string testResult();
    void testResult(const std::string& testResult);
